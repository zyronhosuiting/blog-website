...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  useEffect(() => {
    ...
    // Add resize observer to update height when window size changes
    ...
    >
      <div className="max-w-7xl mx-auto py-10 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-muted-foreground text-sm md:text-base max-w-2xl">
          A timeline of my professional experience and key milestones that have
          shaped my career in technology and development.
        </p>
      </div>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        <div
          ...
          className="absolute md:left-8 left-8 top-0 overflow-hidden w-[2px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-border dark:via-border to-transparent to-[99%]"
        >
          <motion.div
            style={{
